...
function ngakjadi() {
  location.replace("http://localhost/UTS/Client/main.php?p=mhs")
}
</script>
<script src="http://localhost/UTS/Client/mahasiswa/mhscaridata.js"></script>
<script src="http://localhost/UTS/client/mahasiswa/mhsdeletedata.js"></script>